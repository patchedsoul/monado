...
bool ffmpeg_frameserver_enumerate_sources(ffmpeg_frameserver_instance_t*, ffmpeg_source_descriptor_t* cameras, uint32_t* count);
bool ffmpeg_frame_get(frame_t* _frame);
void ffmpeg_register_callback(void* func);
bool ffmpeg_seek(uint64_t timestamp);
bool ffmpeg_stream_start();
