...
mt_device_create(char* device_name,bool log_verbose, bool log_debug) {
	...
	md->base.screens[0].w_pixels = 2048;
	md->base.screens[0].h_pixels = 1024;
	md->base.screens[0].nominal_frame_interval_ns = 11000;
	md->base.views[0].viewport.w_pixels = 1024;
	md->base.views[0].viewport.h_pixels = 1024;
	md->base.views[0].viewport.x_pixels=0;
	md->base.views[0].viewport.x_pixels=0;
	md->base.views[1].viewport.w_pixels = 1024;
	md->base.views[1].viewport.h_pixels = 1024;
	md->base.views[1].viewport.x_pixels=1024;
	md->base.views[1].viewport.y_pixels=0;
	md->base.views[0].display.w_pixels = 1024;
	md->base.views[0].display.w_meters = 0.1f;;
	md->base.views[0].display.h_pixels=1024;
	md->base.views[0].display.h_meters=0.1f;
	md->base.views[1].display.w_pixels = 1024;
	md->base.views[1].display.w_meters = 0.1f;;
	md->base.views[1].display.h_pixels=1024;
