...
enum xrt_input_name
{
	...
	XRT_INPUT_VIVE_SYSTEM_CLICK                  = XRT_INPUT_NAME(0x0060, BOOLEAN),
	XRT_INPUT_VIVE_SQUEEZE_CLICK                 = XRT_INPUT_NAME(0x0061, BOOLEAN),
	XRT_INPUT_VIVE_MENU_CLICK                    = XRT_INPUT_NAME(0x0062, BOOLEAN),
	XRT_INPUT_VIVE_TRIGGER_CLICK                 = XRT_INPUT_NAME(0x0063, BOOLEAN),
	XRT_INPUT_VIVE_TRIGGER_VALUE                 = XRT_INPUT_NAME(0x0064, VEC1_ZERO_TO_ONE),
	XRT_INPUT_VIVE_TRACKPAD_X                    = XRT_INPUT_NAME(0x0065, VEC1_ZERO_TO_ONE),
	XRT_INPUT_VIVE_TRACKPAD_Y                    = XRT_INPUT_NAME(0x0066, VEC1_ZERO_TO_ONE),
	XRT_INPUT_VIVE_TRACKPAD_CLICK                = XRT_INPUT_NAME(0x0067, BOOLEAN),
	XRT_INPUT_VIVE_TRACKPAD_TOUCH                = XRT_INPUT_NAME(0x0067, BOOLEAN),
	XRT_INPUT_VIVE_GRIP_POSE                     = XRT_INPUT_NAME(0x0068, POSE),
	XRT_INPUT_VIVE_AIM_POSE                      = XRT_INPUT_NAME(0x0069, POSE),

	// special hacky values
	XRT_INPUT_VIVE_TRACKPAD_XY                   = XRT_INPUT_NAME(0x006A, VEC2_MINUS_ONE_TO_ONE),
	// clang-format on
};
