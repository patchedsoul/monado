...
enum xrt_input_name
{
	...
	XRT_INPUT_HYDRA_POSE                         = XRT_INPUT_NAME(0x0039, POSE),
        ...
        XRT_INPUT_DAYDREAM_TOUCHPAD_VALUE_X            = XRT_INPUT_NAME(0x003F, VEC1_ZERO_TO_ONE),
        XRT_INPUT_DAYDREAM_TOUCHPAD_VALUE_Y            = XRT_INPUT_NAME(0x0040, VEC1_ZERO_TO_ONE),

        XRT_INPUT_DAYDREAM_POSE                      = XRT_INPUT_NAME(0x0041, POSE),
